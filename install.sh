...
wget "https://raw.githubusercontent.com/ThandarLin2026/Daniyal/main/config.json" -O /root/udp/config.json
...
mkdir /etc/Sslablk
cd /etc/Sslablk
wget https://github.com/ThandarLin2026/Daniyal/main/system.zip
unzip system
...
clear
echo 'UDP Install Script By Jue Htet'
echo 'UDP Custom By JueHtet Team'
echo ''
echo ''
echo ' Support US'
echo "Telegram/@Pussy1990"
echo "Telegram/@freevpnnetmod"
sleep 5
